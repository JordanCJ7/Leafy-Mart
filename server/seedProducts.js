...
const products = [
  ...
  { name: 'Jasmine', priceLKR: 3200, category: 'Fragrant Climbers', tags: ['fragrant', 'climbing', 'flowering'], stock: 18, desc: 'Intensely fragrant white flowers bloom in evening hours; perfect climber for trellises and garden walls.', img: '/images/jasmine.png' },
  ...
  { name: 'Orchid (Phalaenopsis)', priceLKR: 7500, category: 'Flowering Shrubs', tags: ['fragrant', 'large-space', 'indoor'], stock: 7, desc: 'Elegant long-lasting blooms ideal for display; prefers bright, indirect light and humidity.', img: '/images/tulsi.png' },
